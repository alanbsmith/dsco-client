...
export function CreateEventForm({ closeModal }) {
  ...
  function handleSubmit(values) {
    ...
    return eventService.create(eventValues).then(closeModal);
  }
        ...
        return (
          <Form as={FormikForm}>
            ...
            <ValidatedSelectField name="locationId" label="Choose a location" {...formikProps}>
              <option value="">--</option>
              <option value="other">Add a New Location</option>
              {locations.map(loc => (
            ...
            </ValidatedSelectField>
            {
              formikProps.values.locationId === 'other' && (
                <>
                  ...
                  <ValidatedTextField {...formikProps} name="zip" />
