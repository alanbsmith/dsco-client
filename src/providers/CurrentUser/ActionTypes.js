...
export const DESTROY_CURRENT_USER_REQUEST = 'DESTROY_CURRENT_USER_REQUEST';
export const DESTROY_CURRENT_USER_SUCCESS = 'DESTROY_CURRENT_USER_SUCCESS';
export const DESTROY_CURRENT_USER_FAILURE = 'DESTROY_CURRENT_USER_FAILURE';
